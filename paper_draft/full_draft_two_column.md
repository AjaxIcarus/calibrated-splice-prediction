---
title: "Prior-dependent calibration for OpenSpliceAI-style splice-site prediction under extreme class imbalance"
author: "Shakthi Saravanan Sampath"
abstract: |
...
![Figure 1A. Weighted multiclass expected calibration error.](figures/logit_based/logit_multiclass_ece.png)

![Figure 1B. Weighted multiclass negative log-likelihood.](figures/logit_based/logit_multiclass_nll.png)

![Figure 3A. Multiclass reliability before calibration.](figures/logit_based/reliability_multiclass_uncalibrated.png)

![Figure 3B. Multiclass reliability after genome-prior weighted vector calibration.](figures/logit_based/reliability_multiclass_logit_weighted_vector.png)

![Figure 3C. Acceptor reliability before and after calibration.](figures/logit_based/reliability_acceptor_uncalibrated_vs_weighted.png)

![Figure 3D. Donor reliability before and after calibration.](figures/logit_based/reliability_donor_uncalibrated_vs_weighted.png)
...
Supplementary notes, bootstrap summaries, prior-sensitivity outputs, reliability-bin outputs, and implementation details are provided in `paper_draft/supplementary_materials_v1.md`.