...
def save_combined_figure(
    ...
    figure.suptitle(
        "Flank-400 seed-11 reliability on the reconstructed valid-position "
        "test population",
        fontsize=13,
        y=0.98,
    )
    ...
    figure.savefig(
        output_dir / "reliability_diagrams_flank400_seed11_v2.png",
        dpi=300,
        bbox_inches="tight",
    )
    figure.savefig(
        output_dir / "reliability_diagrams_flank400_seed11_v2.pdf",
        bbox_inches="tight",
    )
    plt.close(figure)
...
def save_individual_figures(
    ...
    for reliability_type, class_name, title, y_label in RELIABILITY_SPECS:
        ...
        figure.tight_layout()
        figure.savefig(
            output_dir / f"reliability_{class_name}_flank400_seed11_v2.png",
            dpi=300,
            bbox_inches="tight",
        )
        plt.close(figure)
...
def main() -> None:
    ...
    save_combined_figure(output_dir, bins, computed_summary)
    save_individual_figures(output_dir, bins, computed_summary)
    ...
    metadata = {
        ...
        "outputs": [
            ...
            "reliability_diagrams_flank400_seed11_v2.png",
            "reliability_diagrams_flank400_seed11_v2.pdf",
            "reliability_argmax_flank400_seed11_v2.png",
            "reliability_acceptor_flank400_seed11_v2.png",
            "reliability_donor_flank400_seed11_v2.png",
